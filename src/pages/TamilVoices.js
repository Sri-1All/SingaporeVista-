      ...
      <section className="py-24 bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="max-w-3xl mx-auto text-center mb-14">
            ...
            <p className="text-gray-600 text-lg leading-8 mt-5">
              Tamil heritage continues to grow as younger generations find
              new ways to express their identity, build communities and
              make their mark in Singapore.
            </p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div>
              ...
              <p className="text-gray-600 text-lg leading-8 mt-7">
                The story of Singapore's Tamil community is not only found
                in its temples, festivals and historic places. It can also
                be seen in the people who continue to keep those traditions
                alive in their everyday lives.
              </p>
...
/*
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            {voices.map((voice) => (
              ...
              <div
                key={voice.id}
                className="group bg-white rounded-3xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-xl hover:-translate-y-2 transition duration-300"
              >
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-5">
            ...
            <div className="bg-amber-50 rounded-3xl p-6 text-center border border-amber-100">
              ...
              <h3 className="font-bold text-gray-900">Artists</h3>
              <p className="text-sm text-gray-500 mt-2">
                Creativity & expression
              </p>
            </div>
            ...
            <div className="bg-blue-50 rounded-3xl p-6 text-center border border-blue-100">
              <div className="text-3xl mb-4">💼</div>
              <h3 className="font-bold text-gray-900">Entrepreneurs</h3>
              <p className="text-sm text-gray-500 mt-2">
                Ideas & enterprise
              </p>
            </div>
            ...
            <div className="bg-purple-50 rounded-3xl p-6 text-center border border-purple-100">
              ...
              <h3 className="font-bold text-gray-900">Writers</h3>
              <p className="text-sm text-gray-500 mt-2">
                Stories & language
              </p>
            </div>
            ...
            <div className="bg-rose-50 rounded-3xl p-6 text-center border border-rose-100">
              <div className="text-3xl mb-4">🤝</div>
              <h3 className="font-bold text-gray-900">Leaders</h3>
              <p className="text-sm text-gray-500 mt-2">
                Community & service
              </p>
            </div>
            ...
            <div className="bg-orange-50 rounded-3xl p-6 text-center border border-orange-100">
              <div className="text-3xl mb-4">🏅</div>
              <h3 className="font-bold text-gray-900">Creators</h3>
              <p className="text-sm text-gray-500 mt-2">
                New ideas & influence
              </p>
            </div>
